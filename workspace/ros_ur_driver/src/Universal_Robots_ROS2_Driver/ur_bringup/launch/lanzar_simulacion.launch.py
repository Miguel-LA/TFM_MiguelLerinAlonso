...
def generate_launch_description():
    ...
    control = IncludeLaunchDescription(
                ...
                )]), launch_arguments={'ur_type': 'ur10','use_fake_hardware': 'true','launch_rviz': 'false','robot_ip': '192.168.0.9', 'initial_joint_controller': 'joint_trajectory_controller'}.items()
    )
    ...
    moveit = IncludeLaunchDescription(
                ...
                )]), launch_arguments={'ur_type': 'ur10','use_fake_hardware': 'true','launch_rviz': 'true','robot_ip': '192.168.0.9'}.items()
    )
