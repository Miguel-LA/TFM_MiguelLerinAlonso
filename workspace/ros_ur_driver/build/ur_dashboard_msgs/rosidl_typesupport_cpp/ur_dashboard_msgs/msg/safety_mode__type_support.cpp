...
static const _SafetyMode_type_support_symbol_names_t _SafetyMode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_dashboard_msgs, msg, SafetyMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_dashboard_msgs, msg, SafetyMode)),
  }
};
...
{
  return &::ur_dashboard_msgs::msg::rosidl_typesupport_cpp::SafetyMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_dashboard_msgs, msg, SafetyMode)() {
  return get_message_type_support_handle<ur_dashboard_msgs::msg::SafetyMode>();
}
