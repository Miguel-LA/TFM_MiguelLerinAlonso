...
ur_dashboard_msgs__srv__Load_Request__create()
{
  ...
  ur_dashboard_msgs__srv__Load_Request * msg = (ur_dashboard_msgs__srv__Load_Request *)allocator.allocate(sizeof(ur_dashboard_msgs__srv__Load_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ur_dashboard_msgs__srv__Load_Request__Sequence__init(ur_dashboard_msgs__srv__Load_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ur_dashboard_msgs__srv__Load_Request *)allocator.zero_allocate(size, sizeof(ur_dashboard_msgs__srv__Load_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__srv__Load_Request__Sequence * array = (ur_dashboard_msgs__srv__Load_Request__Sequence *)allocator.allocate(sizeof(ur_dashboard_msgs__srv__Load_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ur_dashboard_msgs__srv__Load_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ur_dashboard_msgs__srv__Load_Request * data =
      (ur_dashboard_msgs__srv__Load_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_dashboard_msgs__srv__Load_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur_dashboard_msgs__srv__Load_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__srv__Load_Response * msg = (ur_dashboard_msgs__srv__Load_Response *)allocator.allocate(sizeof(ur_dashboard_msgs__srv__Load_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ur_dashboard_msgs__srv__Load_Response__Sequence__init(ur_dashboard_msgs__srv__Load_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ur_dashboard_msgs__srv__Load_Response *)allocator.zero_allocate(size, sizeof(ur_dashboard_msgs__srv__Load_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__srv__Load_Response__Sequence * array = (ur_dashboard_msgs__srv__Load_Response__Sequence *)allocator.allocate(sizeof(ur_dashboard_msgs__srv__Load_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ur_dashboard_msgs__srv__Load_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ur_dashboard_msgs__srv__Load_Response * data =
      (ur_dashboard_msgs__srv__Load_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_dashboard_msgs__srv__Load_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur_dashboard_msgs__srv__Load_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
