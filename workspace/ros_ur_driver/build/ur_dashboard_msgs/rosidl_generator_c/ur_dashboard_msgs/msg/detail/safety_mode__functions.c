...
ur_dashboard_msgs__msg__SafetyMode__create()
{
  ...
  ur_dashboard_msgs__msg__SafetyMode * msg = (ur_dashboard_msgs__msg__SafetyMode *)allocator.allocate(sizeof(ur_dashboard_msgs__msg__SafetyMode), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ur_dashboard_msgs__msg__SafetyMode__Sequence__init(ur_dashboard_msgs__msg__SafetyMode__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ur_dashboard_msgs__msg__SafetyMode *)allocator.zero_allocate(size, sizeof(ur_dashboard_msgs__msg__SafetyMode), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__msg__SafetyMode__Sequence * array = (ur_dashboard_msgs__msg__SafetyMode__Sequence *)allocator.allocate(sizeof(ur_dashboard_msgs__msg__SafetyMode__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
ur_dashboard_msgs__msg__SafetyMode__Sequence__are_equal(const ur_dashboard_msgs__msg__SafetyMode__Sequence * lhs, const ur_dashboard_msgs__msg__SafetyMode__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur_dashboard_msgs__msg__SafetyMode__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur_dashboard_msgs__msg__SafetyMode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur_dashboard_msgs__msg__SafetyMode);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur_dashboard_msgs__msg__SafetyMode * data =
      (ur_dashboard_msgs__msg__SafetyMode *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_dashboard_msgs__msg__SafetyMode__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur_dashboard_msgs__msg__SafetyMode__fini(&output->data[i]);
        }
        return false;
      }
    }
